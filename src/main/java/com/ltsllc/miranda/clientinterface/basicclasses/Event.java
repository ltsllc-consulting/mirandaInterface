...
public class Event extends MirandaObject {
    ...
    /**
     * Overwrite this Event with the attributes of another Event.
     *
     * @param o The other Event to merge with.
     * @throws MergeException See {@link MirandaObject#mergeFavorOther(Object)}
     * @see MirandaObject
     */
    ...
    public boolean matches (Object o) {
        ...
        return stringsAreEqual(getGuid(), other.getGuid());
    }
